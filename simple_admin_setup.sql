-- Simple Admin System Setup (No RLS Recursion)
...
-- Drop and recreate admin_users table without RLS
...
-- Don't enable RLS on admin_users to avoid recursion
...
-- Create function to check if user is admin (simplified)
...
-- Create function to check if user is super admin (simplified)
...
-- Test the function
SELECT 'Simple admin system setup completed successfully!' as status; 